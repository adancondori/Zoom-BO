...
//	private static String FACEBOOK_APP_ID = "599054180142916";
//}
...
public class FaceActivity extends Activity {
	...
	private OnLogoutListener mOnLogoutListener = new OnLogoutListener() {
		...
		public void onLogout() {
			// change the state of the button or do whatever you want button_publish_story
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		System.out.println("MainActivity entro 1");
		// test local language
		Utils.updateLanguage(getApplicationContext(), "en");
		Utils.printHashKey(getApplicationContext());
		System.out.println("MainActivity entro 2");
		setContentView(R.layout.activity_face);
		initUI();
		System.out.println("MainActivity entro 3");
	...
	private void publishFeedExample() {
		...
		final Feed feed = new Feed.Builder()
				...
				.setDescription(
						"Prueba de login, publish feeds and open graph stories, invite friends and more. ACC. ")
				.setPicture("http://zoom.bo/images/web-en-construccion.jpg")
				.setLink("http://zoom.bo")
				.build();
	...
	private void publishPhotoExample() {
		mButtonPublishPhoto.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// take screenshot
				final Bitmap bitmap = Utils.takeScreenshot(FaceActivity.this);

				// create Photo instace and add some properties
				Photo photo = new Photo(bitmap);
				photo.addDescription("Screenshot para Zoom Bolivia.. www.zoom.bo");
//				photo.addPlace("110619208966868");
				photo.addPlace("103741479664252");
	...
	private void inviteExamples() {
		...
		mButtonInviteAll.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				mSimpleFacebook.invite("I invite you to use this app www.zoom.bo",
						onInviteListener);
			}
		});
		...
		mButtonInviteSuggested.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				//zoom
				String[] friends = new String[] { "1374394300", "100001078291308",
						"100002360987696", "363661807087767" };
				mSimpleFacebook.invite(friends, "Te invito a que veas mi aplicacion.  www.zoom.bo",
						onInviteListener);
			}
		});
		...
		mButtonInviteOne.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				String friend = "1374394300";
				mSimpleFacebook.invite(friend, "Te invito a que veas mi aplicacion. www.zoom.bo",
						onInviteListener);
			}
		});
	}
		...
		final OnProfileRequestListener onProfileRequestListener = new SimpleFacebook.OnProfileRequestListener() {
			...
			public void onComplete(Profile profile) {
				...
				AlertDialog dialog = Utils
						.buildProfileResultDialog(FaceActivity.this,
	...
	private void getFriendsExample() {
		...
		final OnFriendsRequestListener onFriendsRequestListener = new SimpleFacebook.OnFriendsRequestListener() {
			...
			public void onComplete(List<Profile> friends) {
				hideDialog();
				Log.i(TAG, "Numero de Amigos = " + friends.size());
				toast("Numero de Amigos = " + friends.size());
			}
	...
	private void getAlbumsExample() {
		...
		final OnAlbumsRequestListener onAlbumsRequestListener = new SimpleFacebook.OnAlbumsRequestListener() {
			...
			public void onComplete(List<Album> albums) {
				hideDialog();
				Log.i(TAG, "Numero de Albunes= " + albums.size());
				toast("Numero de Albunes = " + albums.size());
			}
	...
	private void showDialog() {
		mProgress = ProgressDialog.show(this, "Procesando...",
				"Esperando a Facebook", true);
	}
