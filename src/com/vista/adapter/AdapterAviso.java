	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			case TYPE_SEPARATOR:
				...
				break;
			case TYPE_PERFIL:
				convertView = mInflater.inflate(R.layout.adapter_item_avisos,
						null);
				convertView.setBackgroundResource(R.color.blanco);

				holder.title = (TextView) convertView
						.findViewById(R.id.titlecontexto);
				break;
			case TYPE_ITEM:
				convertView = mInflater.inflate(R.layout.adapter_item_avisos,
						null);
