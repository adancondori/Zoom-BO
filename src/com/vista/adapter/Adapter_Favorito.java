...
public class Adapter_Favorito extends BaseAdapter {
	...
	public Adapter_Favorito(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			case TYPE_ELEMENTO:
				convertView = mInflater.inflate(R.layout.adapter_item_favorito,
						null);

				holder.title = (TextView) convertView
						.findViewById(R.id.txt_nombre);
				holder.text_detalle = (TextView) convertView
						.findViewById(R.id.text_detalle);
				break;
			}
		...
		if (mData.get(position).getTipo() == TYPE_ELEMENTO) {
			holder.text_detalle.setText(mData.get(position).getTelefono());
		}
