...
import com.vista.adapter.AdapterEvento;
...
public class EventoFragment extends ListFragment {
	// *------Variales-------------------------------
	private PullToRefreshListView mDrawerList;
	private String[] navMenuTitles;
	private TypedArray listevent;
	LayoutInflater inflater;
	AdapterEvento drawerListAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		drawerListAdapter = new AdapterEvento(getActivity());
		menuslidingInfo();
	...
	public void menuslidingInfo() {
		...
		for (int i = 0; i < navMenuTitles.length; i++) {
			...
			switch (AdapterPerfil.TYPE_ITEM) {
			case AdapterPerfil.TYPE_ITEM:
				if (i % 2 == 0) {
					drawerListAdapter.addSeparatorItem(new NavDrawerItem(
							aux[1], listevent.getResourceId(i, -1)),
